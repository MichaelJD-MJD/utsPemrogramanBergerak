import {
  ...
  const SelectRoomFP = ({ navigation }) => {
    const handleSelectEquipmentFP = () => {
      navigation.navigate("SelectEquipmentFP");
    };
  
    const handleDetailRoomFP = (image) => {
      navigation.navigate("DetailRoomFP", {
        image,
      });
    };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={handleSelectEquipmentFP}
          >
