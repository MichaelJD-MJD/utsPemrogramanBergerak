import {
  ...
  const DetailRoomFP = ({ navigation, route }) => {
      const {image} = route.params;
  
       const handleFormRentFP = () => {
         // Navigasi ke HomeScreen setelah login
         navigation.navigate("FormRentFP");
       };
    ...
    return (
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.detailContainer}>
          ...
          <Text style={styles.facultyText}>Fakultas Pertanian</Text>
        </View>
        ...
        <View style={styles.roomInfoContainer}>
          ...
          <Text style={styles.infoText}>
            <Text style={styles.boldText}>Lokasi:</Text> Gedung Pertanian Bukit
          </Text>
          <Text style={styles.infoText}>
