import {
  ...
  const SelectEquipmentFP = ({ navigation }) => {
    const handleFormRentEquipmentFP = (image) => {
      navigation.navigate("FormRentEquipmentFP", {
        image,
      });
    };
        ...
        <ScrollView style={styles.content}>
          <View style={styles.roomCard}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleFormRentEquipmentFP(peralatanKursi)}
            >
          ...
          <View style={styles.roomCard}>
            ...
            <TouchableOpacity
              style={styles.detailButton}
              onPress={() => handleFormRentEquipmentFP(peralatanSofa)}
            >
              <Text style={styles.detailButtonText}>Detail</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.roomCard}>
            ...
            <TouchableOpacity
              style={styles.detailButton}
              onPress={() => handleFormRentEquipmentFP(peralatanTv)}
            >
              <Text style={styles.detailButtonText}>Detail</Text>
            </TouchableOpacity>
          </View>
  ...
  export default SelectEquipmentFP;
