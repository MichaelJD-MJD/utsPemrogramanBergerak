...
const SelectEquipmentKedokteran = ({ navigation }) => {
  const handleFormRentEquipmentKedokteran = (image) => {
    navigation.navigate("FormRentEquipmentKedokteran", {
      image,
    });
  };
      ...
      <ScrollView style={styles.content}>
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleFormRentEquipmentKedokteran(peralatanKursi)}
          >
        ...
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            style={styles.detailButton}
            onPress={() => handleFormRentEquipmentKedokteran(peralatanSofa)}
          >
            <Text style={styles.detailButtonText}>Detail</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            style={styles.detailButton}
            onPress={() => handleFormRentEquipmentKedokteran(peralatanTv)}
          >
            <Text style={styles.detailButtonText}>Detail</Text>
          </TouchableOpacity>
        </View>
...
export default SelectEquipmentKedokteran;
