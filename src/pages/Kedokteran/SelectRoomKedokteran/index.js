...
const SelectRoomKedokteran = ({ navigation }) => {
  const handleDetailRoomKedokteran = (image) => {
    // Pastikan screen "DetailRoomKedokteran" terdaftar dengan benar di navigator
    navigation.navigate("DetailRoomKedokteran", {
      image, // Mengirim data gambar ke screen DetailRoomKedokteran
    });
  };

  const handleSelectEquipmentKedokteran = () => {
    navigation.navigate("SelectEquipmentKedokteran");
  };
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={handleSelectEquipmentKedokteran}
        >
      ...
      <ScrollView style={styles.content}>
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleDetailRoomKedokteran(selectRoom1)}
          >
        ...
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            style={styles.detailButton}
            onPress={() => handleDetailRoomKedokteran(selectRoom2)}
          >
            <Text style={styles.detailButtonText}>Detail</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.roomCard}>
          ...
          <TouchableOpacity
            style={styles.detailButton}
            onPress={() => handleDetailRoomKedokteran(selectRoom3)}
          >
            <Text style={styles.detailButtonText}>Detail</Text>
          </TouchableOpacity>
        </View>
...
export default SelectRoomKedokteran;
